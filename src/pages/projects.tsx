...
export default function Projects() {
  return (
    <>
      ...
      />
      <NextSeo
        title="Projects by Yasmine Mahjoubi"
        description="Explore a collection of projects by Yasmine Mahjoubi, a seasoned Full Stack Developer. From innovative web applications to responsive interfaces, discover the depth and diversity of my work."
